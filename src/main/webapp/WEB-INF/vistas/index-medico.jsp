  ...
  <body>
          ...
          <a href="./medicos.html">
            <div class="card">
              <div>
                ...
                <div class="cardName">Pacientes disponibles</div>
              </div>
              <div class="iconBox">
            ...
            <table>
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <h4>Maria <br /><span>Paciente</span></h4>
                  </td>
                </tr>
                <tr>
                  <td width="60px">
                  ...
                  <td>
                    <h4>Juan <br /><span>Paciente</span></h4>
                  </td>
                </tr>
                <tr>
                  <td width="60px">
                  ...
                  <td>
                    <h4>Sara <br /><span>Paciente</span></h4>
                  </td>
                </tr>
              </tbody>
            </table>
    ...
    <script>
      ...
      for (var i = 0; i < cancelar.length; i++) {
        ...
        cancelar[i].addEventListener('click', function() {
          Swal.fire({
